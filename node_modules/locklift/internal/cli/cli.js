...
const getContractCode_1 = __importDefault(require("./commands/getContractCode"));
...
const main = async () => {
    ...
    commander_1.program.addCommand(clean_1.default);
    ...
    commander_1.program.addCommand(getContractCode_1.default);
