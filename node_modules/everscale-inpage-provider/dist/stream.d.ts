 ...
 * @category Stream
 */
export type BothFinite<F extends boolean, F1 extends boolean> = F extends true ? F1 extends true ? true : false : false;
/**
 * @category Stream
 */
 ...
 * @category Stream
 */
export type MakeDelayedPromise<F> = F extends (...args: infer Args) => infer R ? (...args: Args) => DelayedPromise<R> : never;
/**
 * @category Stream
 */
