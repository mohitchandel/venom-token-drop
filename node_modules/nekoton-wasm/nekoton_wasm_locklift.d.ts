...
*/
export function executeLocalExtended(config: string, account: string, message: string, utime: number, disable_signature_check: boolean, block_seed?: string, overwrite_balance?: string, global_id?: number, trace_logs?: boolean): TransactionExecutorExtendedOutput;
/**
* @param {string} tvc
* @param {string} contract_abi
...
export interface InitOutput {
  ...
  readonly executeLocalExtended: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number) => void;
